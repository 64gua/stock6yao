...
qtcreator_file  = "md_viewer.ui" # Enter file here.
...
class MyWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.model.setNameFilters(['*.note']) 
        ...
        self.btn_markdown.clicked.connect(self.back2markdown)
        self.btn_html.clicked.connect(self.htmlformat)
        ...
        self.actTransfer.triggered.connect(self.transfer)
    ...
    def md2html(self,mdtext):
        import re
        # Example text containing the ![]() format
        #text = "This is an image: ![](images/A1.jpg) and here is another ![](images/B2.jpg)."
        # Define the pattern to match ![](image_path)
        pattern = r'!\[\]\((.*?)\)'
        replacement = r'<img src="\1">'
        result = re.sub(pattern, replacement, mdtext)
        return result
        ...
        for root, dirs, files in os.walk(CURRENT_DIR):
            ...
            for file in files:
                ...
                if file.endswith('.note'):
                    ...
                    #newcontent_html=self.txtContent.toHtml()
                    #print("plainText:" , newcontent)
                    #print("html: ", newcontent_html)
                        f.write(newcontent)
                        print(i, file)
    ...
    def file_selected(self, index):
       ...
       # if os.path.isfile(file_path) and (file_path.endswith('.md') or file_path.endswith('.note')) :
        if os.path.isfile(file_path):
            ...
            self.mdstatus=1
            self.txtContent.setPlainText(content)
            #self.txtContent.setMarkdown(content)
    ...
    def saveContent(self):
        ...
        print("save new change to file is OK!")
    ...
    def paipan(self):
        if self.txtGuaName.text()=="NULL" or self.txtGuaDate.text()=="NULL":
            ...
            #escaped_text = html.escape(guacont)
            #html_cont = guacont.replace("\n", "<br>")
            #print("escape html:", guacont1)
            #print("original content:",guacont)
